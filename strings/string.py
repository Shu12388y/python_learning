...
letter='''this is a letter and multiline string operation and I will do some of the string opertion like silcing and find th word present in the the string or not and more operators can be used to do the string operation is nad is'''

# slicing operation
# let us modify it 

# n=int(input("Enter the first index: "))
# m=int(input("Enter the last index: "))
